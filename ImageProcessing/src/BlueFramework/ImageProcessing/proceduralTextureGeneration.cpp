...
void diamondStep(std::vector<float> &heightfield, int startx, int starty, int resolution, int iteration, float roughness) {
    ...
    float values[4] = {
        ...
        heightfield[idx(startx + resolution, starty + resolution, resolution_global)]
    };
...
void squareStep(std::vector<float> &heightfield, int startx, int starty, int resolution, int iteration, float roughness) {
    ...
    int pos0 = idx(startx, starty - resolution / 2, resolution_global),
        pos1 = idx(startx + resolution / 2, starty, resolution_global),
        pos2 = idx(startx, starty + resolution / 2, resolution_global),
        pos3 = idx(startx - resolution / 2, starty, resolution_global);

    float h0 = (values[0] + values[1] + values[2] + values[4]) / 4.0f,
        h1 = (values[2] + values[4] + values[5] + values[7]) / 4.0f,
        h2 = (values[4] + values[6] + values[7] + values[8]) / 4.0f,
        h3 = (values[1] + values[3] + values[4] + values[6]) / 4.0f;
