...
#define TINYFORMAT_DEFINE_FORMATVALUE_CHAR(charType)                                                            \
	\
inline void                                                                                                     \
	formatValue(std::ostream& out, const char* /*fmtBegin*/, const char* fmtEnd, int /**/, charType value) \
{ \
		switch (*(fmtEnd - 1)) {                                                                                \
		case 'u':                                                                                               \
		case 'd':                                                                                               \
		...
		case 'o':                                                                                               \
		case 'X':                                                                                               \
		case 'x': out << static_cast<int>(value); break;                                                        \
...
#undef TINYFORMAT_DEFINE_FORMATVALUE_CHAR
	...
	namespace detail {
		...
		private:
			template <typename T>
			static void formatImpl(std::ostream& out, const char* fmtBegin, const char* fmtEnd, int ntrunc, const void* value) {
		...
		inline const char* printFormatStringLiteral(std::ostream& out, const char* fmt) {
			...
			for (; true; ++c) {
				switch (*c) {
				case '\0': out.write(fmt, static_cast<std::streamsize>(c - fmt)); return c;
				case '%':
		...
		inline const char*
		streamStateFromFormat(std::ostream& out, bool& spacePadPositive, int& ntrunc, const char* fmtStart, const detail::FormatArg* formatters, int& argIndex, int numFormatters) {
			if (*fmtStart != '%') {
			...
			out.unsetf(std::ios::adjustfield | std::ios::basefield | std::ios::floatfield | std::ios::showbase | std::ios::boolalpha | std::ios::showpoint | std::ios::showpos
			           | std::ios::uppercase);
			...
			case 'o':
				...
				intConversion = true;
				break;
			case 'X': out.setf(std::ios::uppercase);
			case 'x':
			case 'p':
				out.setf(std::ios::hex, std::ios::basefield);
				intConversion = true;
				break;
			case 'E': out.setf(std::ios::uppercase);
			case 'e':
				out.setf(std::ios::scientific, std::ios::floatfield);
				out.setf(std::ios::dec, std::ios::basefield);
				break;
			case 'F': out.setf(std::ios::uppercase);
			case 'f': out.setf(std::ios::fixed, std::ios::floatfield); break;
			case 'G': out.setf(std::ios::uppercase);
			case 'g':
				out.setf(std::ios::dec, std::ios::basefield);
