...
if(WIN32) # The only platform it makes sense to check for Windows 10 SDK
...
getenv_path(DXSDK_DIR)
	...
	if(MSVC14)
		find_path(DirectX12_INCLUDE_DIR NAMES d3d12.h HINTS "C:/Program Files (x86)/Windows Kits/10/Include/10.0.14393.0/um" "C:/Program Files/Windows Kits/10/Include/10.0.14393.0/um")
		find_path(DirectX12_INCLUDE_DIR_SHARED NAMES dxgi1_4.h HINTS "C:/Program Files (x86)/Windows Kits/10/Include/10.0.14393.0/shared" "C:/Program Files/Windows Kits/10/Include/10.0.14393.0/shared")
		
		set(DirectX12_LibDirX86	"C:/Program Files (x86)/Windows Kits/10/Lib/10.0.14393.0/um/${MSVC_CXX_ARCHITECTURE_ID}")
		set(DirectX12_LibDirX64	"C:/Program Files/Windows Kits/10/Lib/10.0.14393.0/um/${MSVC_CXX_ARCHITECTURE_ID}")
